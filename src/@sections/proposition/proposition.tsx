        ...
        <Container>
          <Flex.Col justifyContent="center" alignItems="center">
            ...
            <Link href="https://design-system-ruddy.vercel.app" target="_blank">
              <Button variant="alfa" as="a" marginBottom="1rem" onClick={onOpenModal}>Read documentation</Button>
            </Link>
            <Link href="https://github.com/actarian/design-system" target="_blank">
              <Button variant="gamma" as="a" onClick={() => onOpenDrawer('cart')}>view on GitHub</Button>
            </Link>
          </Flex.Col>
        </Container>
      </Section>
